...
> **อุปมาที่ไม่พัง — ลูกเต๋าถ่วงน้ำหนัก** · ตัวการแจกแจง = *ตารางความน่าจะเป็นของลูกเต๋า* ·
> **ทอยลูกเต๋า** = $a \sim \pi_\theta(\cdot\mid s)$ ได้หน้าใดหน้าหนึ่ง ทอยใหม่ได้คนละหน้า ·
> **เปิดตารางดูว่าหน้า 6 มีโอกาสเท่าไร** = $\pi_\theta(a\mid s)$ เปิดกี่ครั้งก็ได้เลขเดิม ·
...
>
> อุปมาเครื่องชงกาแฟข้างบนใช้ได้เฉพาะความต่างระหว่าง *ตัวเครื่อง* กับ *ของที่ออกมา*
