...
> อยู่ในวงเล็บแปลว่า *มี $a$ อยู่แล้ว กำลังเอาไปถามคำถามกับมัน*
>
> เทียบกับเครื่องชงกาแฟ: $a \sim \pi_\theta(\cdot\mid s)$ คือ **กดปุ่ม** (ก่อนกดยังไม่มีกาแฟ) ·
> $\pi_\theta(a\mid s)$ คือ **เอากาแฟแก้วที่ได้มาแล้วไปถามเครื่องว่า "ปกติชงออกมาแบบนี้บ่อยแค่ไหน"** ·
> ลำดับเวลาจึงเป็น `.sample()` ก่อนเสมอ แล้วค่อย `.log_prob(a)`
