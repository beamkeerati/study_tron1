...
| `cfg/SF/limx_base_env_cfg.py:484` | `num_envs` (ค่าปริยาย) | 4096 | 2 | ถูกทับด้วย CLI `--num_envs 2048` | 05 §4.7 |
...
## 8. ตัวอย่างเดียวที่ใช้ทั้งสามโน้ต
...
$V = 650$, $\delta = 28.15$, $\rho = 1.25$, $L_V = 781.2$ (walkthrough ต้นทาง — เหลือเป็นตัวอย่างขนาดจริงในโน้ต 07 §6 และ errata ในโน้ต 06 §4 เท่านั้น)
